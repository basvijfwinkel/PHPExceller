 ...
 */
class PHPExceller_Shared_String
{
    /**    Constants                */
    /**    Regular Expressions        */
    //    Fraction
    ...
    public static function convertToNumberIfFraction(&$operand)
    {
        if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
            ...
            $operand = PHPExceller_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
            return true;
        }
        return false;
    ...
    /**
     * Set the decimal separator. Only used by PHPExceller_Style_NumberFormat::toFormattedString()
     * to format output by PHPExceller_Writer_HTML and PHPExceller_Writer_PDF
     *
    ...
    /**
     * Set the thousands separator. Only used by PHPExceller_Style_NumberFormat::toFormattedString()
     * to format output by PHPExceller_Writer_HTML and PHPExceller_Writer_PDF
     *
    ...
    /**
     * Set the currency code. Only used by PHPExceller_Style_NumberFormat::toFormattedString()
     *        to format output by PHPExceller_Writer_HTML and PHPExceller_Writer_PDF
     *
