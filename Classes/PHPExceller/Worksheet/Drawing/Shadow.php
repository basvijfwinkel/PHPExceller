...
class Shadow implements IComparable
{
    ...
    /**
     * Create a new PHPExceller_Worksheet_Drawing_Shadow
     */
    public function __construct()
    {
        ...
        $this->distance    = 2;
        $this->direction   = 0;
        $this->alignment   = PHPExceller_Worksheet_Drawing_Shadow::SHADOW_BOTTOM_RIGHT;
        $this->color       = new PHPExceller_Style_Color(PHPExceller_Style_Color::COLOR_BLACK);
        $this->alpha       = 50;
    }
