...
/**
 * PHPExceller_Worksheet_PageSetup
 *
 * <code>
...
class PageSetup
{
     ...
     * @var int
     */
    private $paperSize = PHPExceller_Worksheet_PageSetup::PAPERSIZE_LETTER;
     ...
     * @var string
     */
    private $orientation = PHPExceller_Worksheet_PageSetup::ORIENTATION_DEFAULT;
    ...
    /**
     * Create a new PHPExceller_Worksheet_PageSetup
     */
     ...
     */
    public function setPaperSize($pValue = PHPExceller_Worksheet_PageSetup::PAPERSIZE_LETTER)
    {
     ...
     * @return PHPExceller_Worksheet_PageSetup
     */
    public function setOrientation($pValue = PHPExceller_Worksheet_PageSetup::ORIENTATION_DEFAULT) {
    ...
    public function setScale($pValue = 100, $pUpdate = true) {
        ...
        if (($pValue >= 0) || is_null($pValue)) {
            ...
            throw new PHPExceller_Exception("Scale must not be negative");
        }
    }
    ...
    public function getPrintArea($index = 0) {
        ...
        throw new PHPExceller_Exception("Requested Print Area does not exist");
    }
    ...
    public function setPrintArea($value, $index = 0, $method = self::SETPRINTRANGE_OVERWRITE) {
        if (strpos($value,'!') !== false) {
            throw new PHPExceller_Exception('Cell coordinate must not specify a worksheet.');
        } elseif (strpos($value,':') === false) {
            throw new PHPExceller_Exception('Cell coordinate must be a range of cells.');
        } elseif (strpos($value,'$') !== false) {
        ...
        if ($method == self::SETPRINTRANGE_OVERWRITE) {
            if ($index == 0) {
                ...
                if (($index <= 0) || ($index > count($printAreas))) {
                    throw new PHPExceller_Exception('Invalid index for setting print range.');
                }
            ...
            throw new PHPExceller_Exception('Invalid method for setting print range.');
        }
    }
    ...
    public function setPrintAreaByColumnAndRow($column1, $row1, $column2, $row2, $index = 0, $method = self::SETPRINTRANGE_OVERWRITE)
    {
        return $this->setPrintArea(
            PHPExceller_Cell::stringFromColumnIndex($column1) . $row1 . ':' . PHPExceller_Cell::stringFromColumnIndex($column2) . $row2,
            $index,
            $method
        );
    }
