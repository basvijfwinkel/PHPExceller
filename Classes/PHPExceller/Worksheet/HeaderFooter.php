...
class HeaderFooter
{
     ...
     *
     * @var PHPExceller_Worksheet_HeaderFooterDrawing[]
     */
    private $headerFooterImages = array();

    /**
     * Create a new PHPExceller_Worksheet_HeaderFooter
     */
     ...
     *
     * @param PHPExceller_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws PHPExceller_Exception
     * @return void
     */
    public function addImage(PHPExceller_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT)
    {
     ...
     *
     * @param PHPExceller_Worksheet_HeaderFooterDrawing[] $images
     * @throws PHPExceller_Exception
     * @return void
     */
    ...
    {
        if (!is_array($images)) {
            throw new PHPExceller_Exception('Invalid parameter!');
        }
     ...
     *
     * @return PHPExceller_Worksheet_HeaderFooterDrawing[]
     */
