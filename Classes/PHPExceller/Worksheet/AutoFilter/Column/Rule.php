...
//    const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER    = 'allDatesInQuarter';    //    <dynamicFilter type="Q2"/> for Quarter 2
     ...
     * Autofilter Column
     *
     * @var PHPExceller_Worksheet_AutoFilter_Column
     */
    private $parent = null;
    ...
    /**
     * Create a new PHPExceller_Worksheet_AutoFilter_Column_Rule
     *
     * @param PHPExceller_Worksheet_AutoFilter_Column $pParent
     */
    public function __construct(PHPExceller_Worksheet_AutoFilter_Column $pParent = null)
    {
        $this->parent = $pParent;
    }
    ...
    public function setRuleType($pRuleType = self::AUTOFILTER_RULETYPE_FILTER)
    {
        if (!in_array($pRuleType, self::$ruleTypes)) {
            throw new PHPExceller_Exception('Invalid rule type for column AutoFilter Rule.');
        }
    ...
    public function setValue($pValue = '')
    {
        if (is_array($pValue)) {
            ...
            if (count($pValue) == 0) {
                throw new PHPExceller_Exception('Invalid rule value for column AutoFilter Rule.');
            }
    ...
    public function setOperator($pOperator = self::AUTOFILTER_COLUMN_RULE_EQUAL)
    {
        ...
        if ((!in_array($pOperator, self::$operators)) &&
            ...
            throw new PHPExceller_Exception('Invalid operator for column AutoFilter Rule.');
        }
     ...
     *
     * @param PHPExceller_Worksheet_AutoFilter_Column
     * @return void
     */
    public function setParent(PHPExceller_Worksheet_AutoFilter_Column $pParent = null)
    {
        $this->parent = $pParent;
    }
