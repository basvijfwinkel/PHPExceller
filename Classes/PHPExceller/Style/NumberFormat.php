...
class NumberFormat extends Supervisor implements IComparable
{
     ...
     * @var string
     */
    protected $formatCode = PHPExceller_Style_NumberFormat::FORMAT_GENERAL;
    ...
    /**
     * Create a new PHPExceller_Style_NumberFormat
     *
     ...
     *
     * <code>
     * $objPHPExceller->getActiveSheet()->getStyle('B2')->getNumberFormat()->applyFromArray(
     *        array(
     *            'code' => PHPExceller_Style_NumberFormat::FORMAT_CURRENCY_EUR_SIMPLE
     *        )
     * );
     * </code>
     *
     ...
     * @return void
     */
    public function setFormatCode($pValue = PHPExceller_Style_NumberFormat::FORMAT_GENERAL)
    {
        if ($pValue == '') {
            $pValue = PHPExceller_Style_NumberFormat::FORMAT_GENERAL;
        }
        if ($this->isSupervisor) {
    ...
    private static function fillBuiltInFormatCodes()
    {
        ...
        if (is_null(self::$builtInFormats)) {
            ...
            // General
            self::$builtInFormats[0] = PHPExceller_Style_NumberFormat::FORMAT_GENERAL;
    ...
    private static function formatAsDate(&$value, &$format)
    {
        ...
        $dateObj = PHPExceller_Shared_Date::ExcelToPHPObject($value);
    ...
    private static function formatAsFraction(&$value, &$format)
    {
        ...
        $GCD = PHPExceller_Calculation_MathTrig::GCD($decimalPart, $decimalDivisor);
     ...
     */
    public static function toFormattedString($value = '0', $format = PHPExceller_Style_NumberFormat::FORMAT_GENERAL, $callBack = null)
    {
        ...
        if (($format === PHPExceller_Style_NumberFormat::FORMAT_GENERAL) || ($format === PHPExceller_Style_NumberFormat::FORMAT_TEXT)) {
            return $value;
        }
                    ...
                    if (preg_match($number_regex, $m, $matches)) {
                        ...
                        if ($useThousands) {
                            $value = number_format(
                                $value,
                                strlen($right),
                                PHPExceller_Shared_String::getDecimalSeparator(),
