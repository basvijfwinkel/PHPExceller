...
class PHPExceller_Helper_HTML
{
    ...
    public function toRichTextObject($html)
    {
        ...
        $this->richTextObject = new PHPExceller_RichText();;
    ...
    protected function buildTextRun()
    {
        ...
        if ($this->color) {
            $richtextRun->getFont()->setColor(new PHPExceller_Style_Color('ff' . $this->color));
        }
        if ($this->bold) {
        ...
        if ($this->underline) {
            $richtextRun->getFont()->setUnderline(PHPExceller_Style_Font::UNDERLINE_SINGLE);
        }
        if ($this->superscript) {
