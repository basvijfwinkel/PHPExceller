...
class PHPExceller
{
     ...
     * Document properties
     *
     * @var PHPExceller_DocumentProperties
     */
    private $properties;
     ...
     * Document security
     *
     * @var PHPExceller_DocumentSecurity
     */
    private $security;
    ...
    */
    ...
    public function getSheetByCodeName($pName = '')
    {
     ...
     /**
     * Create a new PHPExceller with one Worksheet
     */
    public function __construct()
    {
        $this->uniqueID = uniqid();
        $this->calculationEngine = new PHPExceller_Calculation($this);

        // Initialise worksheet collection and add one worksheet
        $this->workSheetCollection = array();
        $this->workSheetCollection[] = new PHPExceller_Worksheet($this);
        $this->activeSheetIndex = 0;

        // Create document properties
        $this->properties = new PHPExceller_DocumentProperties();

        // Create document security
        $this->security = new PHPExceller_DocumentSecurity();

        // Set named ranges
        $this->namedRanges = array();

        // Create the cellXf supervisor
        $this->cellXfSupervisor = new PHPExceller_Style(true);
        $this->cellXfSupervisor->bindParent($this);

        // Create the default style
        $this->addCellXf(new PHPExceller_Style);
        $this->addCellStyleXf(new PHPExceller_Style);
    }
    ...
    /**
     * Disconnect all worksheets from this PHPExceller workbook object,
     *    typically so that the PHPExceller object can be unset
     *
     */
     ...
     * Get properties
     *
     * @return PHPExceller_DocumentProperties
     */
     ...
     * Set properties
     *
     * @param PHPExceller_DocumentProperties    $pValue
     */
    public function setProperties(PHPExceller_DocumentProperties $pValue)
    {
     ...
     * Get security
     *
     * @return PHPExceller_DocumentSecurity
     */
     ...
     * Set security
     *
     * @param PHPExceller_DocumentSecurity    $pValue
     */
    public function setSecurity(PHPExceller_DocumentSecurity $pValue)
    {
    ...
    {
        $newSheet = new PHPExceller_Worksheet($this);
     ...
     * @throws PHPExceller_Exception
     */
    public function addSheet(PHPExceller_Worksheet $pSheet, $iSheetIndex = null)
    {
     ...
     * @throws PHPExceller_Exception
     */
    public function getIndex(PHPExceller_Worksheet $pSheet)
    {
        ...
        throw new PHPExceller_Exception("Sheet does not exist.");
    }
    ...
    {
        if (($worksheet = $this->getSheetByName($pValue)) instanceof PHPExceller_Worksheet) {
            $this->setActiveSheetIndex($this->getIndex($worksheet));
            return $worksheet;
        }

        throw new PHPExceller_Exception('Workbook does not contain sheet:' . $pValue);
    }
     ...
     * Add external sheet
     *
     * @param  PHPExceller_Worksheet $pSheet External sheet to add
     * @param  int|null $iSheetIndex Index where sheet should go (0,1,..., or null for last)
     * @throws PHPExceller_Exception
     * @return PHPExceller_Worksheet
     */
    public function addExternalSheet(PHPExceller_Worksheet $pSheet, $iSheetIndex = null)
    {
        if ($this->sheetNameExists($pSheet->getTitle())) {
            throw new PHPExceller_Exception("Workbook already contains a worksheet named '{$pSheet->getTitle()}'. Rename the external sheet first.");
        }
     ...
     * Add named range
     *
     * @param  PHPExceller_NamedRange $namedRange
     * @return boolean
     */
    public function addNamedRange(PHPExceller_NamedRange $namedRange)
    {
     ...
     * @return PHPExceller_NamedRange|null
     */
    public function getNamedRange($namedRange, PHPExceller_Worksheet $pSheet = null)
    {
        $returnValue = null;
     ...
     * @return -
     */
    public function removeNamedRange($namedRange, PHPExceller_Worksheet $pSheet = null)
    {
        if ($pSheet === null) {
            if (isset($this->namedRanges[$namedRange])) {
     ...
     *
     * @return PHPExceller_WorksheetIterator
     */
    public function getWorksheetIterator()
    {
        return new PHPExceller_WorksheetIterator($this);
    }
     ...
     *
     * @param  string $pValue
     * @return PHPExceller_Style|boolean False if no match found
     */
     ...
     *
     * @param  PHPExceller_Style $pCellStyle
     * @return boolean
     */
    ...
    public function getDefaultStyle()
    {
        ...
        throw new PHPExceller_Exception('No default style found for this workbook');
    }

    /**
     * Add a cellXf to the workbook
     *
     * @param PHPExceller_Style $style
     */
    public function addCellXf(PHPExceller_Style $style)
    {
    ...
    public function removeCellXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellXfCollection) - 1) {
            throw new PHPExceller_Exception("CellXf index is out of bounds.");
        } else {
     ...
     *
     * @param PHPExceller_Style $pStyle
     */
    public function addCellStyleXf(PHPExceller_Style $pStyle)
    {
    ...
    public function removeCellStyleXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellStyleXfCollection) - 1) {
            throw new PHPExceller_Exception("CellStyleXf index is out of bounds.");
        } else {
    ...
    public function garbageCollect()
    {
        ...
        if (empty($this->cellXfCollection)) {
            $this->cellXfCollection[] = new PHPExceller_Style();
        }
