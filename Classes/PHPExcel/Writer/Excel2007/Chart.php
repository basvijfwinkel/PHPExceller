...
class PHPExceller_Writer_Excel2007_Chart extends PHPExceller_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeChart(PHPExceller_Chart $pChart = NULL)
    {
        ...
        if ($this->getParentWriter()
            ->getUseDiskCaching())
        {
            $objWriter = new PHPExceller_Shared_XMLWriter(PHPExceller_Shared_XMLWriter::STORAGE_DISK, $this->getParentWriter()
        ...
        {
            $this->writePlotAreaSecondaryAxis($pChart->getPlotArea() , $pChart->getXAxisLabel() , $pChart->getYAxisLabel() , $objWriter, $pChart->getWorksheet() , $pChart->getChartAxisX() , $pChart->getChartAxisY() , $pChart->getMajorGridlines() , $pChart->getMinorGridlines() , $pChart->getSecondaryYAxis() , $pChart->getSecondaryXAxis() , $pChart->getSecondaryYAxisLabel());
        }
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeTitle(PHPExceller_Chart_Title $title = NULL, $objWriter)
    {
        if (is_null($title))
        {
            return;
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeLegend(PHPExceller_Chart_Legend $legend = NULL, $objWriter)
    {
        if (is_null($legend))
        {
            return;
     ...
     *
     * @param  PHPExceller_Chart_PlotArea $plotArea
     * @param  PHPExceller_Chart_Title $xAxisLabel
     * @param  PHPExceller_Chart_Title $yAxisLabel
     * @param  PHPExceller_Chart_Axis $xAxis
     * @param  PHPExceller_Chart_Axis $yAxis
     * @param  PHPExceller_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writePlotArea(PHPExceller_Chart_PlotArea $plotArea, PHPExceller_Chart_Title $xAxisLabel = NULL, PHPExceller_Chart_Title $yAxisLabel = NULL, $objWriter, PHPExceller_Worksheet $pSheet, PHPExceller_Chart_Axis $xAxis, PHPExceller_Chart_Axis $yAxis, PHPExceller_Chart_GridLines $majorGridlines, PHPExceller_Chart_GridLines $minorGridlines)
    {
        if (is_null($plotArea))
        {
            return;
        ...
        $id1 = $this->generateUniqueID(array());
        $id2 = $this->generateUniqueID(array(
            $id1
        ));
        ...
        foreach ($chartTypes as $chartIndex => $chartType)
        {
            ...
            for ($i = 0;$i < $groupCount;++$i)
            {
                ...
                if ($groupType == $chartType)
                {
                    ...
                    if ($groupType === PHPExceller_Chart_DataSeries::TYPE_RADARCHART)
                    {
                        $objWriter->startElement('c:radarStyle');
                        $objWriter->writeAttribute('val', $plotStyle);
                        $objWriter->endElement();
                    }
                    elseif ($groupType === PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART)
                    {
            ...
            $this->writeDataLbls($objWriter, $layout, $groupType);

            if ($chartType === PHPExceller_Chart_DataSeries::TYPE_LINECHART)
            {
            ...
            elseif (($chartType === PHPExceller_Chart_DataSeries::TYPE_BARCHART) || ($chartType === PHPExceller_Chart_DataSeries::TYPE_BARCHART_3D))
            {
            ...
            elseif ($chartType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART)
            {
            ...
            elseif ($chartType === PHPExceller_Chart_DataSeries::TYPE_STOCKCHART)
            {
            ...
            if (($chartType !== PHPExceller_Chart_DataSeries::TYPE_PIECHART) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_PIECHART_3D) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_DONUTCHART) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART))
            {
            ...
            elseif (($chartType == PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART) || ($chartType == PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART))
            {
                $objWriter->startElement('c:axId');
                $objWriter->writeAttribute('val', $id2);
                $objWriter->endElement();
            ...
            else
            {
                ...
                if ($chartType === PHPExceller_Chart_DataSeries::TYPE_DONUTCHART)
                {
        ...
        if (($chartType !== PHPExceller_Chart_DataSeries::TYPE_PIECHART) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_PIECHART_3D) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_DONUTCHART))
        {
            // write out the primary axis
            if (($chartType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART) || ($chartType === PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART))
            {
                $this->writeValAx($objWriter, $plotArea, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines);
                $this->writeValAx($objWriter, $plotArea, $yAxisLabel, $chartType, $id1, $id2, $valIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines, false, true);
            }
            else
            {
                $this->writeCatAx($objWriter, $plotArea, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $xAxis, $yAxis);
                $this->writeValAx($objWriter, $plotArea, $yAxisLabel, $chartType, $id1, $id2, $valIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines);
            }
        }
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writePlotAreaSecondaryAxis(PHPExceller_Chart_PlotArea $plotArea, PHPExceller_Chart_Title $xAxisLabel = NULL, PHPExceller_Chart_Title $yAxisLabel = NULL, $objWriter, PHPExceller_Worksheet $pSheet, PHPExceller_Chart_Axis $xAxis, PHPExceller_Chart_Axis $yAxis, PHPExceller_Chart_GridLines $majorGridlines, PHPExceller_Chart_GridLines $minorGridlines, PHPExceller_Chart_Axis $secondaryYAxis = NULL, PHPExceller_Chart_Axis $secondaryXAxis = NULL, PHPExceller_Chart_Title $secondaryYAxisLabel = NULL)
    {
        if (is_null($plotArea))
        {
            return;
        ...
        $id3 = $this->generateUniqueID(array(
            $id1,
            $id2
        ));
        $id4 = $this->generateUniqueID(array(
            $id1,
            $id2,
            $id3
        ));
        ...
        if (($chartType !== PHPExceller_Chart_DataSeries::TYPE_PIECHART) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_PIECHART_3D) && ($chartType !== PHPExceller_Chart_DataSeries::TYPE_DONUTCHART))
        {
            ...
            if ($chartType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART)
            {
                $this->writeValAx($objWriter, $plotArea, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $xAxis, $secondaryYAxis, $majorGridlines, $minorGridlines, true);
            }
            else
            {
                $this->writeCatAx($objWriter, $plotArea, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $secondaryXAxis, $secondaryYAxis, true);
            }
            $this->writeValAx($objWriter, $plotArea, $secondaryYAxisLabel, $chartType, $id1, $id2, $valIsMultiLevelSeries, $secondaryXAxis, $secondaryYAxis, $majorGridlines, $minorGridlines, true);

            // write out the primary axis
            if ($chartType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART)
            {
                $this->writeValAx($objWriter, $plotArea, $xAxisLabel, $chartType, $id3, $id4, $catIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines);
            }
            else
            {
                $this->writeCatAx($objWriter, $plotArea, $xAxisLabel, $chartType, $id3, $id4, $catIsMultiLevelSeries, $xAxis, $yAxis);
            }
            $this->writeValAx($objWriter, $plotArea, $yAxisLabel, $chartType, $id3, $id4, $valIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines);
     ...
     *
     * @param  PHPExceller_Shared_XMLWriter $objWriter XML Writer
     * @param  PHPExceller_Chart_Layout $chartLayout Chart layout
     *
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeDataLbls($objWriter, $chartLayout, $groupType = NULL)
    {
        ...
        if (($groupType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART) || ($groupType === PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART))
        {
        ...
        {
            if ($groupType != PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART)
            {
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeCatAx($objWriter, PHPExceller_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $isSecondaryYAxis = false)
    {
        ...
        if (!is_null($xAxisLabel))
        {
            ...
            $objWriter->writeRawData(PHPExceller_Shared_String::ControlCharacterPHP2OOXML($caption));
            $objWriter->endElement();
     ...
     * @param  PHPExceller_Chart_Axis $xAxis
     * @param  PHPExceller_Chart_Axis $yAxis
     * @param  PHPExceller_Chart_GridLines $majorGridlines
     * @param  PHPExceller_Chart_GridLines $minorGridlines
     * @param  boolean $isSecondaryAxis
     *
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeValAx($objWriter, PHPExceller_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines, $isSecondaryAxis = false, $reverseIDs = false)
    {
        ...
        if (!($isSecondaryAxis && $yAxis->getAxisOptionsProperty('hide_major_gridlines')))
        {
            ...
            if (!is_null($majorGridlines->getShadowProperty('presets')))
            {
                ...
                $objWriter->startElement("a:{$majorGridlines->getShadowProperty(array(
                    'color',
                    'type'
                )) }");
        ...
        if ($minorGridlines->getObjectState())
        {
            ...
            if (!is_null($minorGridlines->getShadowProperty('presets')))
            {
                ...
                $objWriter->startElement("a:{$minorGridlines->getShadowProperty(array(
                    'color',
                    'type'
                )) }");
        ...
        if (!is_null($yAxisLabel))
        {
            ...
            if ($groupType !== PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART)
            {
        ...
        if (!is_null($xAxis->getGlowProperty('size')))
        {
            ...
            $objWriter->startElement("a:{$xAxis->getGlowProperty(array(
                'color',
                'type'
            )) }");
        ...
        if (!is_null($xAxis->getShadowProperty('presets')))
        {
            ...
            $objWriter->startElement("a:{$xAxis->getShadowProperty(array(
                'color',
                'type'
            )) }");
    ...
    private static function _getChartType($plotArea, $nouniques = false)
    {
        ...
        else
        {
            ...
            {
                throw new PHPExceller_Writer_Exception('Chart is not yet implemented');
            }
        }
        return $chartType;
    }
     ...
     *
     * @param  PHPExceller_Chart_DataSeries $plotGroup
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, PHPExceller_Worksheet $pSheet)
    {
        ...
        if (($groupType == PHPExceller_Chart_DataSeries::TYPE_BARCHART) || ($groupType == PHPExceller_Chart_DataSeries::TYPE_BARCHART_3D))
        {
        ...
        if (($groupType !== PHPExceller_Chart_DataSeries::TYPE_RADARCHART) && ($groupType !== PHPExceller_Chart_DataSeries::TYPE_STOCKCHART))
        {

            if ($groupType !== PHPExceller_Chart_DataSeries::TYPE_LINECHART)
            {
                if (($groupType == PHPExceller_Chart_DataSeries::TYPE_PIECHART) || ($groupType == PHPExceller_Chart_DataSeries::TYPE_PIECHART_3D) || ($groupType == PHPExceller_Chart_DataSeries::TYPE_DONUTCHART) || ($plotSeriesCount > 1))
                {
        ...
        foreach ($plotSeriesOrder as $plotSeriesIdx => $plotSeriesRef)
        {
            ...
            if (($groupType == PHPExceller_Chart_DataSeries::TYPE_PIECHART) || ($groupType == PHPExceller_Chart_DataSeries::TYPE_PIECHART_3D) || ($groupType == PHPExceller_Chart_DataSeries::TYPE_DONUTCHART))
            {
            ...
            // color of the line
            if ($groupType !== PHPExceller_Chart_DataSeries::TYPE_LINECHART && $groupType !== PHPExceller_Chart_DataSeries::TYPE_STOCKCHART && $groupType !== PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART)
            {
                $objWriter->startElement('c:spPr');
                $objWriter->startElement('a:solidFill');
                $objWriter->startElement('a:srgbClr');
            ...
            else if (($groupType == PHPExceller_Chart_DataSeries::TYPE_LINECHART) || ($groupType == PHPExceller_Chart_DataSeries::TYPE_STOCKCHART))
            {
                $objWriter->startElement('c:spPr');
                $objWriter->startElement('a:ln');
                // line width
                $objWriter->writeAttribute('w', $plotSeriesLabel->getLineWidth());
                if ($groupType == PHPExceller_Chart_DataSeries::TYPE_STOCKCHART)
                {
            ...
            if ($plotSeriesValues)
            {
                ...
                if ($plotSeriesMarker)
                {
                    ...
                    if (($groupType == PHPExceller_Chart_DataSeries::TYPE_LINECHART) && ($usesCustomColor))
                    {
            ...
            if (($groupType === PHPExceller_Chart_DataSeries::TYPE_BARCHART) || ($groupType === PHPExceller_Chart_DataSeries::TYPE_BARCHART_3D) || ($groupType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART))
            {
            ...
            if (($groupType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART) || ($groupType === PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART))
            {
                ...
                if ($bubbleChartLabels)
                {
                    ...
                    foreach ($bubbleChartLabels->getDataValues() as $plotLabelKey => $plotLabelValue)
                    {
                        ...
                        $objWriter->writeAttribute('id', '{' . $this->generateUUID() . '}');
                        ...
                        $objWriter->startElement('c15:dlblFieldTable');
                        $objWriter->endElement();
                        $objWriter->startElement('c15:showDataLabelsRange');
                        $objWriter->writeAttribute('val', "1");
                        $objWriter->endElement();
                        $objWriter->endElement();
                        ...
                        $objWriter->writeAttribute('val', $uniqueID);
                        $objWriter->endElement();
                        $objWriter->endElement();
                        $objWriter->endElement();
                    ...
                    $objWriter->writeAttribute('val', "25000");
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->startElement('a:latin');
                    $objWriter->writeAttribute('typeface', "+mn-lt");
                    $objWriter->endElement();
                    $objWriter->startElement('a:ea');
                    $objWriter->writeAttribute('typeface', "+mn-ea");
                    $objWriter->endElement();
                    $objWriter->startElement('a:cs');
                    $objWriter->writeAttribute('typeface', "+mn-cs");
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->startElement('a:endParaRPr');
                    $objWriter->writeAttribute('lang', "en-JP");
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->endElement();
                    ...
                    $objWriter->writeAttribute('val', "1");
                    $objWriter->endElement();
                    $objWriter->startElement('c15:showLeaderLines');
                    $objWriter->writeAttribute('val', "1");
                    $objWriter->endElement();
                    ...
                    $objWriter->endElement();
                    $objWriter->startElement('a:lumOff');
                    $objWriter->writeAttribute('val', "65000");
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->startElement('a:round');
                    $objWriter->endElement();
                    $objWriter->endElement();
                    $objWriter->startElement('a:effectLst');
                    $objWriter->endElement();
            ...
            if ($plotSeriesCategory && ($plotSeriesCategory->getPointCount() > 0))
            {
                ...
                $datatype = 'str';
                if ($plotSeriesCategory->getDataType() == PHPExceller_Chart_DataSeriesValues::DATASERIES_TYPE_NUMBER)
                {
                    $datatype = 'num';
                }
                $this->writePlotSeriesValues($plotSeriesCategory, $objWriter, $groupType, $datatype, $pSheet);
                $objWriter->endElement();
            }
            ...
            if (($groupType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART) || ($groupType === PHPExceller_Chart_DataSeries::TYPE_SCATTERCHART))
            {
                if ($groupType === PHPExceller_Chart_DataSeries::TYPE_BUBBLECHART)
                {
                    ...
                    if ($bubbleChartSizes)
                    {
                        $this->writeBubblesSizes($bubbleChartSizes, $objWriter, $pSheet, true);
                    }
                    else
                    {
                        $this->writeBubblesSizes($plotSeriesValues, $objWriter, $pSheet, false);
                    }
                }
                ...
                if ($bubbleChartLabels)
                {
                    $this->writeBubblesLabels($bubbleChartLabels, $objWriter, $pSheet);
                }
            }
     ...
     *
     * @param  PHPExceller_Chart_DataSeriesValues $plotSeriesLabel
     * @param  PHPExceller_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExceller_Writer_Exception
     */
     ...
     *
     * @param  PHPExceller_Chart_DataSeriesValues $plotSeriesValues
     * @param  PHPExceller_Shared_XMLWriter $objWriter XML Writer
     * @param  string $groupType Type of plot for dataseries
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', PHPExceller_Worksheet $pSheet)
    {
     ...
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeBubblesSizes($plotSeriesValuesSizes, $objWriter, PHPExceller_Worksheet $pSheet, $hasBubbleSizes)
    {
    ...
    private function _writeBubblesLabels($plotSeriesLabels, $objWriter, PHPExceller_Worksheet $pSheet)
    {
        $objWriter->startElement('c:extLst');
        $objWriter->startElement('c:ext');
     ...
     * Write Layout
     *
     * @param  PHPExceller_Chart_Layout $layout
     * @param  PHPExceller_Shared_XMLWriter $objWriter XML Writer
     *
     * @throws  PHPExceller_Writer_Exception
     */
    private function _writeLayout(PHPExceller_Chart_Layout $layout = NULL, $objWriter)
    {
