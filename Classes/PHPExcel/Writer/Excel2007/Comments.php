...
class PHPExceller_Writer_Excel2007_Comments extends PHPExceller_Writer_Excel2007_WriterPart
{
     ...
     */
    public function writeComments(PHPExceller_Worksheet $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @param     PHPExceller_Comment                $pComment            Comment
     * @param    array                            $pAuthors            Array of authors
     * @throws     PHPExceller_Writer_Exception
     */
    private function writeComment(PHPExceller_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', PHPExceller_Comment $pComment = null, $pAuthors = null)
    {
        // comment
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    public function writeVMLComments(PHPExceller_Worksheet $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    private function writeVMLComment(PHPExceller_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', PHPExceller_Comment $pComment = null)
    {
         // Metadata
         list($column, $row) = PHPExceller_Cell::coordinateFromString($pCellReference);
         $column = PHPExceller_Cell::columnIndexFromString($column);
         $id = 1024 + $column + $row;
         $id = substr($id, 0, 4);
