 ...
 */
class PHPExceller_Writer_Excel2007_Rels extends PHPExceller_Writer_Excel2007_WriterPart
{
    /**
     ...
     */
    public function writeRelationships(PHPExceller $pPHPExceller = null)
    {
        // Create XML writer
        $objWriter = null;
        ...
        if ($pPHPExceller->hasRibbon()) {
            $this->writeRelationShip(
                $objWriter,
                5,
                'http://schemas.microsoft.com/office/2006/relationships/ui/extensibility',
                $pPHPExceller->getRibbonXMLData('target')
            );
        }
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    public function writeWorkbookRelationships(PHPExceller $pPHPExceller = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    public function writeWorksheetRelationships(PHPExceller_Worksheet $pWorksheet = null, $pWorksheetId = 1, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
...
//
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    public function writeDrawingRelationships(PHPExceller_Worksheet $pWorksheet = null, &$chartRef, $includeCharts = FALSE)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
        ...
        $objWriter->writeAttribute('xmlns', 'http://schemas.openxmlformats.org/package/2006/relationships');
            ...
            while ($iterator->valid()) {
                if ($iterator->current() instanceof PHPExceller_Worksheet_Drawing
                    || $iterator->current() instanceof PHPExceller_Worksheet_MemoryDrawing) {
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    public function writeHeaderFooterDrawingRelationships(PHPExceller_Worksheet $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     PHPExceller_Writer_Exception
     */
    private function _writeRelationship(PHPExceller_Shared_XMLWriter $objWriter = null, $pId = 1, $pType = '', $pTarget = '', $pTargetMode = '')
    {
        if ($pType != '' && $pTarget != '') {
            // Write relationship
