...
abstract class PHPExceller_Reader_Abstract implements PHPExceller_Reader_IReader
{
    ...
    /**
     * PHPExceller_Reader_IReadFilter instance
     *
     * @var PHPExceller_Reader_IReadFilter
     */
     ...
     * Read filter
     *
     * @return PHPExceller_Reader_IReadFilter
     */
     ...
     * Set read filter
     *
     * @param PHPExceller_Reader_IReadFilter $pValue
     * @return PHPExceller_Reader_IReader
     */
    public function setReadFilter(PHPExceller_Reader_IReadFilter $pValue)
    {
    ...
    protected function openFile($pFilename)
    {
        ...
        if ($this->fileHandle === false) {
            throw new PHPExceller_Reader_Exception("Could not open file " . $pFilename . " for reading.");
        }
    }
    ...
    public function securityScan($xml)
    {
        ...
        if (preg_match($pattern, $xml)) {
            throw new PHPExceller_Reader_Exception('Detected use of ENTITY in XML, spreadsheet file load() aborted to prevent XXE/XEE attacks');
        }
        return $xml;
    }
