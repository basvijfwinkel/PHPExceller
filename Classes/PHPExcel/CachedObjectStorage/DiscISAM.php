...
/**
 * PHPExceller_CachedObjectStorage_DiscISAM
 *
 ...
 */
class PHPExceller_CachedObjectStorage_DiscISAM extends PHPExceller_CachedObjectStorage_CacheBase implements PHPExceller_CachedObjectStorage_ICache
{
    /**
    ...
    public function copyCellCollection(PHPExceller_Worksheet $parent)
    {
        ...
        $newFileName = $this->cacheDirectory.'/PHPExceller.'.$baseUnique.'.cache';
    ...
    public function __construct(PHPExceller_Worksheet $parent, $arguments)
    {
        $this->cacheDirectory    = ((isset($arguments['dir'])) && ($arguments['dir'] !== null))
                                    ? $arguments['dir']
                                    : PHPExceller_Shared_File::sys_get_temp_dir();

        parent::__construct($parent);
        if (is_null($this->fileHandle)) {
            $baseUnique = $this->getUniqueID();
            $this->fileName = $this->cacheDirectory.'/PHPExceller.'.$baseUnique.'.cache';
            $this->fileHandle = fopen($this->fileName, 'a+');
        }
    }
