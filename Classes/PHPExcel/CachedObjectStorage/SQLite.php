...
/**
 * PHPExceller_CachedObjectStorage_SQLite
 *
 ...
 */
class PHPExceller_CachedObjectStorage_SQLite extends PHPExceller_CachedObjectStorage_CacheBase implements PHPExceller_CachedObjectStorage_ICache
{
    /**
     * Database table name
     *
    ...
    protected function storeData()
    {
        if ($this->currentCellIsDirty && !empty($this->currentObjectID)) {
            ...
            if (!$this->DBHandle->queryExec("INSERT OR REPLACE INTO kvp_".$this->TableName." VALUES('".$this->currentObjectID."','".sqlite_escape_string(serialize($this->currentObject))."')")) {
                throw new PHPExceller_Exception(sqlite_error_string($this->DBHandle->lastError()));
            }
    ...
    public function moveCell($fromAddress, $toAddress)
    {
        ...
        if ($result === false) {
            throw new PHPExceller_Exception($this->DBHandle->lastErrorMsg());
        }
