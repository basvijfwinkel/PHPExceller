...
if (!defined('PHPEXCELLER_ROOT')) {
    ...
    require(PHPEXCELLER_ROOT . 'PHPExcel/Autoloader.php');
}
...
/**
 * PHPExceller_Calculation_Engineering
 *
...
class PHPExceller_Calculation_Engineering
{
    ...
    {
        $x    = (is_null($x))    ? 0.0 :    PHPExceller_Calculation_Functions::flattenSingleValue($x);
        $ord    = (is_null($ord))    ? 0.0 :    PHPExceller_Calculation_Functions::flattenSingleValue($ord);
        ...
        if ((is_numeric($x)) && (is_numeric($ord))) {
            ...
            if (abs($x) <= 30) {
                $fResult = $fTerm = pow($x / 2, $ord) / PHPExceller_Calculation_MathTrig::FACT($ord);
                $ordK = 1;
                $fSqrX = ($x * $x) / 4;
                do {
                    $fTerm *= $fSqrX;
            ...
            return (is_nan($fResult)) ? PHPExceller_Calculation_Functions::NaN() : $fResult;
        }
    ...
    public static function BESSELK($x, $ord)
    {
        ...
        if ((is_numeric($x)) && (is_numeric($ord))) {
            ...
            return (is_nan($fBk)) ? PHPExceller_Calculation_Functions::NaN() : $fBk;
        }
        return PHPExceller_Calculation_Functions::VALUE();
    }
    ...
    public static function BESSELY($x, $ord)
    {
        ...
        if ((is_numeric($x)) && (is_numeric($ord))) {
            ...
            return (is_nan($fBy)) ? PHPExceller_Calculation_Functions::NaN() : $fBy;
        }
        return PHPExceller_Calculation_Functions::VALUE();
    }
    ...
    {
        $x    = PHPExceller_Calculation_Functions::flattenSingleValue($x);
        $places    = PHPExceller_Calculation_Functions::flattenSingleValue($places);
    ...
    {
        $realNumber = (is_null($realNumber)) ? 0.0 : PHPExceller_Calculation_Functions::flattenSingleValue($realNumber);
        $imaginary  = (is_null($imaginary))  ? 0.0 : PHPExceller_Calculation_Functions::flattenSingleValue($imaginary);
        $suffix     = (is_null($suffix))     ? 'i' : PHPExceller_Calculation_Functions::flattenSingleValue($suffix);
    ...
    {
        $complexNumber    = PHPExceller_Calculation_Functions::flattenSingleValue($complexNumber);
    ...
    {
        $complexNumber = PHPExceller_Calculation_Functions::flattenSingleValue($complexNumber);
        $realNumber    = PHPExceller_Calculation_Functions::flattenSingleValue($realNumber);
    ...
    {
        $complexDividend    = PHPExceller_Calculation_Functions::flattenSingleValue($complexDividend);
        $complexDivisor    = PHPExceller_Calculation_Functions::flattenSingleValue($complexDivisor);
    ...
    {
        $complexNumber1    = PHPExceller_Calculation_Functions::flattenSingleValue($complexNumber1);
        $complexNumber2    = PHPExceller_Calculation_Functions::flattenSingleValue($complexNumber2);
    ...
    public static function GESTEP($number, $step = 0)
    {
        ...
        $step    = PHPExceller_Calculation_Functions::flattenSingleValue($step);
     ...
     *            PHPExceller follows Excel 2010 behaviour, and accepts nagative arguments.
     *
     *    Excel Function:
     *        ERF(lower[,upper])
     *
    ...
    {
        $lower    = PHPExceller_Calculation_Functions::flattenSingleValue($lower);
        $upper    = PHPExceller_Calculation_Functions::flattenSingleValue($upper);
    ...
    public static function CONVERTUOM($value, $fromUOM, $toUOM)
    {
        ...
        $fromUOM = PHPExceller_Calculation_Functions::flattenSingleValue($fromUOM);
        $toUOM   = PHPExceller_Calculation_Functions::flattenSingleValue($toUOM);
