...
class PHPExceller_Shared_Font
{
     ...
     *
     * @param     PHPExceller_Style_Font            $font            Font object
     * @param     PHPExceller_RichText|string    $cellText        Text to calculate width
     * @param     integer                        $rotation        Rotation angle
     * @param     PHPExceller_Style_Font|NULL    $defaultFont    Font object
     * @return     integer        Column width
     */
    public static function calculateColumnWidth(PHPExceller_Style_Font $font, $cellText = '', $rotation = 0, PHPExceller_Style_Font $defaultFont = null)
    {
        // If it is rich text, use plain text
        if ($cellText instanceof PHPExceller_RichText) {
        ...
        $columnWidth = PHPExceller_Shared_Drawing::pixelsToCellDimension($columnWidth, $defaultFont);
     ...
     *
     * @param string $text
     * @param PHPExceller_Style_Font
     * @param int $rotation
     * @return int
     * @throws PHPExceller_Exception
     */
    public static function getTextWidthPixelsExact($text, PHPExceller_Style_Font $font, $rotation = 0)
    {
        if (!function_exists('imagettfbbox')) {
            throw new PHPExceller_Exception('GD library needs to be enabled');
        }
...
//        $upperLeftCornerY  = $textBox[7];
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, PHPExceller_Style_Font $font = null, $rotation = 0)
    {
        ...
        switch ($fontName) {
            case 'Calibri':
                ...
                $columnWidth = (int) (8.26 * PHPExceller_Shared_String::CountCharacters($columnText));
                $columnWidth = $columnWidth * $fontSize / 11; // extrapolate from font size
                break;

            case 'Arial':
                // value 7 was found via interpolation by inspecting real Excel files with Arial 10 font.
//                $columnWidth = (int) (7 * PHPExceller_Shared_String::CountCharacters($columnText));
                // value 8 was set because of experience in different exports at Arial 10 font.
                $columnWidth = (int) (8 * PHPExceller_Shared_String::CountCharacters($columnText));
    ...
    public static function getTrueTypeFontFileFromFont($font)
    {
        if (!file_exists(self::$trueTypeFontPath) || !is_dir(self::$trueTypeFontPath)) {
            throw new PHPExceller_Exception('Valid directory to TrueType Font files not specified');
        }
        ...
        switch ($name) {
            ...
            case 'Verdana':
                ...
                break;
            default:
                throw new PHPExceller_Exception('Unknown font name "'. $name .'". Cannot map to TrueType font file');
                break;
        }
        ...
        if (!file_exists($fontFile)) {
            throw new PHPExceller_Exception('TrueType Font file not found');
        }
     ...
     *
     * @param PHPExceller_Style_Font $font The workbooks default font
     * @param boolean $pPixels true = return column width in pixels, false = return in OOXML units
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(PHPExceller_Style_Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(PHPExceller_Style_Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
