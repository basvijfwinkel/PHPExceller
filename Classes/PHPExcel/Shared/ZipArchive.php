 ...
 * @package    PHPExceller_Shared_ZipArchive
...
class PHPExceller_Shared_ZipArchive
{
    ...
    {
        $this->tempDir = PHPExceller_Shared_File::sys_get_temp_dir();
    ...
    public function addFromString($localname, $contents)
    {
        ...
        if ($res == 0) {
            throw new PHPExceller_Writer_Exception("Error zipping files : " . $this->zip->errorInfo(true));
        }
