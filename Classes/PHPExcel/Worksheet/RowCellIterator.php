...
/**
 * PHPExceller_Worksheet_RowCellIterator
 *
 ...
 */
class PHPExceller_Worksheet_RowCellIterator extends PHPExceller_Worksheet_CellIterator implements Iterator
{
    /**
     * Row index
     *
     ...
     */
    public function __construct(PHPExceller_Worksheet $subject = null, $rowIndex = 1, $startColumn = 'A', $endColumn = null)
    {
    ...
    public function resetStart($startColumn = 'A')
    {
        ...
        $this->seek(PHPExceller_Cell::stringFromColumnIndex($this->startColumn));
    }
