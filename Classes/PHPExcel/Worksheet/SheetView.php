...
class PHPExceller_Worksheet_SheetView
{
    ...
    /**
     * Create a new PHPExceller_Worksheet_SheetView
     */
    ...
    public function setZoomScale($pValue = 100)
    {
        ...
        if (($pValue >= 1) || is_null($pValue)) {
            ...
            throw new PHPExceller_Exception("Scale must be greater than or equal to 1.");
        }
    }
    ...
    public function setView($pValue = null)
    {
        ...
        if (in_array($pValue, self::$sheetViewTypes)) {
            ...
            throw new PHPExceller_Exception("Invalid sheetview layout type.");
        }
    }
