...
class PHPExceller_Worksheet_AutoFilter_Column
{
     ...
     *
     * @var array of PHPExceller_Worksheet_AutoFilter_Column_Rule
     */
    ...
    /**
     * Create a new PHPExceller_Worksheet_AutoFilter_Column
     *
     *    @param    string                           $pColumn        Column (e.g. A)
     *    @param    PHPExceller_Worksheet_AutoFilter  $pParent        Autofilter for this column
     */
    public function __construct($pColumn, PHPExceller_Worksheet_AutoFilter $pParent = null)
    {
     ...
     *
     * @param PHPExceller_Worksheet_AutoFilter
     * @return void
     */
    public function setParent(PHPExceller_Worksheet_AutoFilter $pParent = null)
    {
        $this->parent = $pParent;
    }
    ...
    public function setFilterType($pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER)
    {
        if (!in_array($pFilterType, self::$filterTypes)) {
            throw new PHPExceller_Exception('Invalid filter type for column AutoFilter.');
        }
    ...
    public function setJoin($pJoin = self::AUTOFILTER_COLUMN_JOIN_OR)
    {
        ...
        if (!in_array($pJoin, self::$ruleJoins)) {
            throw new PHPExceller_Exception('Invalid rule connection for column AutoFilter.');
        }
     ...
     *
     * @throws    PHPExceller_Exception
     * @return array of PHPExceller_Worksheet_AutoFilter_Column_Rule
     */
     ...
     * @return    PHPExceller_Worksheet_AutoFilter_Column_Rule
     */
    public function getRule($pIndex)
    {
        if (!isset($this->ruleset[$pIndex])) {
            $this->ruleset[$pIndex] = new PHPExceller_Worksheet_AutoFilter_Column_Rule($this);
        }
    ...
    {
        $this->ruleset[] = new PHPExceller_Worksheet_AutoFilter_Column_Rule($this);
     ...
     *
     * @param    PHPExceller_Worksheet_AutoFilter_Column_Rule    $pRule
     * @param    boolean    $returnRule     Flag indicating whether the rule object or the column object should be returned
     * @return    PHPExceller_Worksheet_AutoFilter_Column|PHPExceller_Worksheet_AutoFilter_Column_Rule
     */
    public function addRule(PHPExceller_Worksheet_AutoFilter_Column_Rule $pRule, $returnRule = true)
    {
