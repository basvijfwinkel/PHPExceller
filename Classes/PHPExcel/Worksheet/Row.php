...
class PHPExceller_Worksheet_Row
{
     ...
     * @param int                        $rowIndex
     */
    public function __construct(PHPExceller_Worksheet $parent = null, $rowIndex = 1)
    {
    ...
    {
        return new PHPExceller_Worksheet_RowCellIterator($this->parent, $this->rowIndex, $startColumn, $endColumn);
    }
}
