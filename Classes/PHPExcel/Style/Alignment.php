...
class PHPExceller_Style_Alignment extends PHPExceller_Style_Supervisor implements PHPExceller_IComparable
{
     ...
     * @var string
     */
    protected $horizontal = PHPExceller_Style_Alignment::HORIZONTAL_GENERAL;
     ...
     * @var string
     */
    protected $vertical = PHPExceller_Style_Alignment::VERTICAL_BOTTOM;
    ...
    /**
     * Create a new PHPExceller_Style_Alignment
     *
     ...
     *
     * <code>
     * $objPHPExceller->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
     *        array(
     *            'horizontal' => PHPExceller_Style_Alignment::HORIZONTAL_CENTER,
     *            'vertical'   => PHPExceller_Style_Alignment::VERTICAL_CENTER,
     *            'rotation'   => 0,
     *            'wrap'            => TRUE
     *        )
     * );
     ...
     * @return void
     */
    public function setHorizontal($pValue = PHPExceller_Style_Alignment::HORIZONTAL_GENERAL)
    {
        if ($pValue == '') {
            $pValue = PHPExceller_Style_Alignment::HORIZONTAL_GENERAL;
        }
     ...
     * @return void
     */
    public function setVertical($pValue = PHPExceller_Style_Alignment::VERTICAL_BOTTOM)
    {
        if ($pValue == '') {
            $pValue = PHPExceller_Style_Alignment::VERTICAL_BOTTOM;
        }
    ...
    {
        // Excel2007 value 255 => PHPExceller value -165
        if ($pValue == 255) {
            $pValue = -165;
        }
        ...
        if (($pValue >= -90 && $pValue <= 90) || $pValue == -165) {
            ...
            throw new PHPExceller_Exception("Text rotation should be a value between -90 and 90.");
        }
    }
