...
class PHPExceller_Style_Fill extends PHPExceller_Style_Supervisor implements PHPExceller_IComparable
{
     ...
     * @var string
     */
    protected $fillType = PHPExceller_Style_Fill::FILL_NONE;
    ...
    /**
     * Create a new PHPExceller_Style_Fill
     *
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        $this->startColor = new PHPExceller_Style_Color(PHPExceller_Style_Color::COLOR_WHITE, $isSupervisor, $isConditional);
        $this->endColor = new PHPExceller_Style_Color(PHPExceller_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
     ...
     *
     * <code>
     * $objPHPExceller->getActiveSheet()->getStyle('B2')->getFill()->applyFromArray(
     *        array(
     *            'type'       => PHPExceller_Style_Fill::FILL_GRADIENT_LINEAR,
     *            'rotation'   => 0,
     *            'startcolor' => array(
     *                'rgb' => '000000'
     *            ),
     ...
     * Set Fill Type
     *
     * @param string $pValue    PHPExceller_Style_Fill fill type
     * @return void
     */
    public function setFillType($pValue = PHPExceller_Style_Fill::FILL_NONE)
    {
        if ($this->isSupervisor) {
     ...
     * @return void
     */
    public function setStartColor(PHPExceller_Style_Color $pValue = null)
    {
     ...
     * @return void
     */
    public function setEndColor(PHPExceller_Style_Color $pValue = null)
    {
        // make sure parameter is a real color and not a supervisor
        $color = $pValue->getIsSupervisor() ? $pValue->getSharedComponent() : $pValue;
