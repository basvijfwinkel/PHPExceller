...
class PHPExceller_Style_Color extends PHPExceller_Style_Supervisor implements PHPExceller_IComparable
{
    ...
    /**
     * Create a new PHPExceller_Style_Color
     *
     ...
     *                                        its ramifications are
     */
    public function __construct($pARGB = PHPExceller_Style_Color::COLOR_BLACK, $isSupervisor = FALSE, $isConditional = FALSE)
    {
        //    Supervisor?
     ...
     *
     * <code>
     * $objPHPExceller->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
     * </code>
     *
     ...
     * @return void
     */
    public function setARGB($pValue = PHPExceller_Style_Color::COLOR_BLACK) {
        if ($pValue == '') {
            $pValue = PHPExceller_Style_Color::COLOR_BLACK;
        }
        if ($this->_isSupervisor) {
    ...
    public static function indexedColor($pIndex, $background=FALSE) {
        ...
        if (array_key_exists($pIndex, self::$_indexedColors)) {
            return new PHPExceller_Style_Color(self::$_indexedColors[$pIndex]);
        }

        if ($background) {
            return new PHPExceller_Style_Color('FFFFFFFF');
        }
        return new PHPExceller_Style_Color('FF000000');
    }
